...
import { ArrowUpRight, Factory, Scale, Warehouse, Leaf } from "lucide-react"

const products = [
  {
    number: "01",
    title: "Pengolahan BRONDOLAN → CPO",
    description:
  ...
  {
    number: "02",
    title: "Penerimaan & Penimbangan BRONDOLAN",
    description:
      "Layanan penerimaan BRONDOLAN dengan jembatan timbang berkapasitas memadai dan pencatatan terstruktur. Kepastian bobot yang akurat dan dokumentasi yang rapi untuk seluruh pemasok.",
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          >
            Dari penerimaan BRONDOLAN hingga penyimpanan CPO, seluruh proses dilakukan
